            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        <?php
                            include "../koneksi.php";
                            $sql = "SELECT login.username, member.nama FROM login INNER JOIN member ON login.id_member=member.id_member WHERE login.username='$user'"; 
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Rekomendasi Tempat Wisata</h1>
                        <hr>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahTempatWisataModal">
                        <i class="fa-solid fa-square-plus"></i> Tambah Rekomendasi Tempat Wisata
                        </button>
                        <br><br>
                        <?php
                            include "../koneksi.php";
