            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Tempat Wisata</h1>
                        <hr>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahTempatWisataModal">
                        <i class="fa-solid fa-square-plus"></i> Tambah Tempat Wisata
                        </button>
                        <!-- Search-->
                        <form action="search_tempat_wisata.php" class="my-4" method="GET">
            ...
            <div class="modal-dialog">
                ...
                <form action="./process/add_tempat_wisata.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="google_map" class="form-control" id="google_map" placeholder="Link Google Map">
                    </div>
                    <div class="mb-3">
